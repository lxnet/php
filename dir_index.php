<?
// Simple secure your directory script.
// 2011 Campai Business Solutions
// Code and rehash by martijn@vanbuijtene.nl

// Do we use the restriction by ip?
// If so fill in Yes or Y, if not leave it empty ""
$IP_BLOCK = "yes";

// Range of ipadresses to allow
$allow = array("213.247.117.155", "456.789.123", "789.123.456");

// Do we use restriction by password>
// If so fill in Yes or Y, if not leave it empty ""
$ASK_PASS = "";
...
// Protected area name
$areaname = "Protected folder";

// Start filebrowser configs
...
// What files and or Folders NOT to include in the file list
$ignore=array('.','..','.htaccess','index.php','icon.php','Thumbs.db',$self); 

// Do we have block by ip?
if ($IP_BLOCK)

		// check the ipadresses in teh array
